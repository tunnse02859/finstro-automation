...
public class APIRequestStep implements Markup {
	...
	public APIRequestStep(HttpUriRequest request, HttpResponse response,String responseBody, List<String> assertionList, List<String> extractedVariable, Throwable exception) {
		this.request = request;
		this.response = response;
	...
	public String getMarkup() {
        ...
        sb.append("<div class='api-title' onclick='toggleDetail(this)'>"); 
        		...
        		sb.append("<a class='api-requestUrl'>" + request.getURI() + "</a>"); 
        		sb.append("</div>"); 
